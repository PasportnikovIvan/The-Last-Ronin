...
//The ui class of the overlay menu when the game is completed
public class GameCompletedOverlay {
    ...
    private void createButtons() {
        quit = new MenuButton(Game.GAME_WIDTH / 2, (int)(255 * Game.SCALE), 2, Gamestate.MENU);
        credit = new MenuButton(Game.GAME_WIDTH / 2, (int)(185 * Game.SCALE), 3, Gamestate.CREDITS);
    }
